  ...
  <div class="mx-auto max-w-5xl text-white" style="height: calc(var(--vh) - 4em)">
    <div class="relative z-50 h-full px-3" v-if="data.length">
      <div class="grid h-full grid-rows-[2.5em_23%_23%_23%_23%]">
        ...
        <div class="grid grid-cols-[1fr_2fr_1fr] items-center justify-items-center" v-for="(item, index) in data" :style="`border-bottom: ${index == data.length - 1 ? 'none' : '1px  solid #EBEDF0'}`">
    ...
    <div class="fixed bottom-0 left-0 right-0 top-0 flex items-center justify-center opacity-50">
      <img class="h-[19.296875em] w-[15.625em]" src="./img/02.png" alt="" />
    </div>
